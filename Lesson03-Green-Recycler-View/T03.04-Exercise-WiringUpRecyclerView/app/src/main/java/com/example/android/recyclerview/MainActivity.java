...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNumersList = (RecyclerView) findViewById(R.id.rv_numbers);
        ...
        mNumersList.setAdapter(mAdapter);
    }
}
